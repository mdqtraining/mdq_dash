...
<script>
    ...
    ratingContainers.forEach((ratingContainer) => {
        ...
        const hiddenInput = ratingContainer.querySelector("input[type='hidden']"); // Find the hidden input
        ...
        stars.forEach((star) => {
            ...
            star.addEventListener("click", function () {
                ...
                hiddenInput.value = value; // Update hidden input with the selected value
            });
        });
