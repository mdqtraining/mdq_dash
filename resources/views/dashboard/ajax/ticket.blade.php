...
<div class="row">
    @if (in_array('tickets', user_modules()) && in_array('total_tickets', $activeWidgets))
        <div class="col-lg-6 col-md-6 mb-3">
                ...
                <div
                    class="bg-white p-3 rounded b-shadow-4 d-flex justify-content-between align-items-center mb-4 mb-md-0 mb-lg-0 br-10">
                    <div class="d-block bg-orangecolor" style="padding: 10px; border-radius:10px;">
                        <i class="fa fa-ticket-alt text-white f-18"></i>
                    </div>
                    <div class="d-block text-capitalize">
                        <h5 class="f-15 f-w-500 mb-20 text-darkest-grey">@lang('app.menu.tickets')</h5>
                        <div class="d-flex">
                            <a href="javascript:;"  class="totalTicketCount" data-status="open"><p class="mb-0 f-15 font-weight-bold d-grid mr-5" style="color:rgb(255,162,29) ;">
