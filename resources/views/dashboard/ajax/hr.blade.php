...
<div class="row">
    ...
    @if (in_array('employees', user_modules()) && in_array('total_new_employee', $activeWidgets))
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 mb-3">
            ...
            <div class="bg-white p-3 rounded b-shadow-4 d-flex justify-content-between align-items-center mb-4 mb-md-0 mb-lg-0 br-10">
                <div class="d-block bg-greencolor" style="padding: 10px; border-radius:10px;">
                    <i class="fa fa-users text-white f-18"></i>
                </div>
                <div class="d-block text-capitalize">
                    <h5 class="f-15 f-w-500 text-darkest-grey">@lang('app.menu.employees')</h5>
                    <div class="d-flex">
                        <a href="javascript:;"  class="total-employees" data-status="open"><p class="mb-0 f-15 font-weight-bold d-grid mr-5" style="color: #6FD943";>
                        ...
                        <a href="javascript:;" class="total-new-employees" data-status="resolved"><p class="mb-0 f-15 font-weight-bold d-grid" style="color: #6FD943 !important;">
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 mb-3">
            <a href="javascript:;" id="total-ex-employees">
                <x-cards.widget :title="__('modules.dashboard.totalEmployeeExits')" :value="$totalEmployeeExits"
                    icon="sign-out-alt" :info="__('messages.employeeExitInfo')" style="color: #ff5733 !important;"/>
            </a>
        </div>
    @endif
