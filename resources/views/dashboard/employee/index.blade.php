    ...
    <div class="row emp-dash-detail">
        ...
        <div class="col-xl-5 col-lg-12 col-md-12 e-d-info-notices">
            <div class="row">
                ...
                <div class="col-md-12 ">
                    <div class="card border-0 b-shadow-4 mb-3 e-d-info" style="padding: 3px 0px">
                        <a @if(!in_array('client', user_roles())) href="{{ route('employees.show', user()->id) }}" @endif>
                            <div class="card-horizontal align-items-center">
                                ...
                                <div class="card-body border-0 pl-0">
                                    <h4 class="card-title text-blue f-18 f-w-500 mb-0">{{ mb_ucfirst($user->name) }}</h4>
                                    <p class="f-14 font-weight-normal text-dark mb-2">
                ...
                <div class="col-md-6 mb-3">
                    <div
                        ...
                        <div class="d-block " style="background-color: #6FD943; padding: 10px; border-radius:10px;">
                            <i class="fa fa-list text-white f-27"></i>
                        </div>
...
<script>
    ...
    $('.keep-open .dropdown-menu').on("click", function(e) {
        e.stopPropagation();
    });
