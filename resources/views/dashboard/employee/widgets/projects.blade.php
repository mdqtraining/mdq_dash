@if (in_array('projects', $activeWidgets) && $sidebarUserPermissions['view_projects'] != 5 && $sidebarUserPermissions['view_projects'] != 'none' && in_array('projects', user_modules()))
    <div class="col-md-6 mb-3">
        <div
            class="bg-white p-20 rounded b-shadow-4 d-flex justify-content-between align-items-center mt-3 mt-lg-0 mt-md-0 br-10">
            <div class="d-block" style="background-color: rgb(255 162 29)!important; padding: 10px; border-radius:10px;">
                <i class="fa fa-layer-group text-white f-27"></i>
            </div>
