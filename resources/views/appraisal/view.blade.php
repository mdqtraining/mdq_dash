        ...
        <div class="add-page">
                ...
                <div class="row p-20">
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group my-3">
                            ...
                            <select class="form-control height-35 f-14" name="branch" id="branch" disabled>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group my-3">
                            ...
                            <select class="form-control height-35 f-14" name="department" id="department" disabled>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group my-3">
                            ...
                            <select class="form-control height-35 f-14" name="employee" id="employee" disabled>
                ...
                <div class="col-md-6 col-lg-4" id="deadlineBox">
                    ...
                    <input type="text" id="monthYearPicker" name="month_year" class="form-control height-35 f-14 bg-white"
                        placeholder="MM/YYYY" value="{{$appraisal->appraisal_date}}" disabled>
                </div>
                ...
                <div class="col-md-12 col-lg-6" id="remarkBox">
                    <div class="form-group my-3">
                        ...
                        <textarea id="remarkInput" name="remark" class="form-control height-35 f-14 bg-white"
                            placeholder="Enter your remarks here..." rows="1" oninput="autoResize(this)" disabled> {{$appraisal->remark}}</textarea>
                    </div>
                </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        setupRatings(".rating_appraisal", false);
    });
</script>
<script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
