        ...
        <x-cards.data class="mt-3">
            <div class="row">
               <div class="col-md-12">
                ...
                <i class="fa fa-check text-blue"></i> <i class="fa fa-arrow-right text-lightest f-11 mx-1"></i>
                ...
                @lang('modules.attendance.halfDay') &nbsp;|&nbsp; <i class="fa fa-exclamation-circle text-primary"></i> <i
                    class="fa fa-arrow-right text-lightest f-11 mx-1"></i>
                @lang('modules.attendance.late') &nbsp;|&nbsp; <i class="fa fa-times text-red"></i> <i
                    class="fa fa-arrow-right text-lightest f-11 mx-1"></i>
                @lang('modules.attendance.absent') &nbsp;|&nbsp; <i class="fa fa-plane-departure" style="color:#ff3a6e;"></i> <i
                    class="fa fa-arrow-right text-lightest f-11 mx-1"></i>
