    ...
    <form id="login-form" action="{{ route('login') }}" class="ajax-form" method="POST">
        {{ csrf_field() }}
            ...
            <div class="form-group text-left">
                <label for="email" class="text-white">@lang('auth.email')</label>
            ...
            <div id="password-section"
                ...
                <div class="form-group text-left">
                    <label for="password" class="text-white">@lang('app.password')</label>
                    <x-forms.input-group>
                        ...
                        <x-slot name="append">
                            <button type="button" data-toggle="tooltip"
                                    ...
                                    class="btn border-grey height-50 toggle-password" style="background-color:white; border-right-color:#6c757d;">
                                <i
                ...
                <div class="form-group text-left ">
                    ...
                    <label for="checkbox-signup" class="cursor-pointer text-white">@lang('app.rememberMe')</label>
                </div>
                ...
                <button type="submit" id="submit-login"
                        class=" f-w-500 rounded w-100 height-50 f-18" >
                    @lang('app.login') <i class="fa fa-arrow-right pl-1"></i>
                </button>

                @if ($company->allow_client_signup)
                    <a href="{{ route('register') }}"
                       class="btn-success f-w-500 rounded w-100 height-50 f-15 mt-3">
                        @lang('app.signUpAsClient')
                    </a>
                @endif
            </div>
