        ...
        return $datatables
            ...
            ->editColumn('client.name', function ($row) {
                return '<div class="media align-items-center">
                    ...
                    <img src="' . $row->client->image_url . '" class="mr-3 taskEmployeeImg rounded-circle" style="border: 1.5px solid #0169fe" alt="' . ucfirst($row->client->name) . '" title="' . ucfirst($row->client->name) . '"></a>
                    <div class="media-body">
