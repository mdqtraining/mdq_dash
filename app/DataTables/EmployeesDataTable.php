    ...
    public function dataTable($query)
    {
        ...
        $datatables->editColumn('current_role_name', function ($row) {
            ...
            if (in_array('admin', $userRole)) {
                return '<span style="font-style: italic; font-weight:strong;">' . __('app.admin') . '</span>';
            }
        ...
        $datatables->editColumn('status', function ($row) {
            if ($row->status == 'active') {
                return '<span class="span-green">' . __('app.active') . '</span>';
            }
        
            return '<span class="span-red">' . __('app.inactive') . '</span>';
        });
        ...
        $datatables->editColumn('employee_id', function ($row) {
            return '<a href="' . route('employees.show', [$row->id]) . '" class="whitebg-blue border-logocolor">' . $row->employee_id . '</a>';
        });
